...
const i18n = {
  ...
  en: {
    ...
    missionOmikujiAuctionListingDesc: 'While registered and logged in, list a card-back design you got from the gacha on Uko Auction. (Uko Auction is still being prepared.)',
    missionOmikujiAuctionWinTitle: 'Win an auction',
    missionOmikujiAuctionWinDesc: 'While registered and logged in, win an item on Uko Auction by outbidding others or buying it now. (Uko Auction is still being prepared.)',
